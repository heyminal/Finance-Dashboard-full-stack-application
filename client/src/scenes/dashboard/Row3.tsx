  ...
  return (
    <>
      <DashboardBox  gridArea="g" >
        ...
        <Box 
          ...
          sx={{
            ...
            "& .MuiDataGrid-cell": {
              borderBottom: `0.25px solid ${palette.grey[800]} !important`,
            },
      ...
      <DashboardBox  gridArea="j" >
        ...
        The Finance Dashboard is an invaluable tool for financial management, offering clear insights into financial performance and enabling informed decision-making. Its intuitive design and comprehensive data presentation make it a must-have for any organization aiming to streamline its financial operations.
        </Typography>
      </DashboardBox>
    </>
  )
